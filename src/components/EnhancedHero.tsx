    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        {[...Array(15)].map((_, i) => (
          <motion.div
            ...
            style={{
              ...
              left: `${Math.random() * 100}%`,
              top: `${Math.random() * 100}%`,
              background: `radial-gradient(circle, rgba(${Math.random() * 100 + 155}, ${Math.random() * 100 + 155}, 255, 0.15) 0%, transparent 70%)`,
              filter: 'blur(40px)',
            }}
            animate={{
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-32">
        <div className="text-center">
          ...
          >
            <motion.img 
              src="figma:asset/f74523f5ded9bfe280a44ba5858fe69254b68eb7.png" 
              alt="Aiwana Solution" 
